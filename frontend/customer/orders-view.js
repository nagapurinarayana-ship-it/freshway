...
// Owns only order-list DOM rendering; order normalization/status helpers remain in orders.js.
(function(){
  const render=(document,list,{esc,formatDate,statusLabel,money,planText})=>{
