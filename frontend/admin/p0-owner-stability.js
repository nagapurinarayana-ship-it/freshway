(()=>{
  ...
  if(typeof baseNavigate==='function'){
    window.navigateAdminScreen=function(id){
      ...
      if(!restoring&&id&&id!==current)history.pushState(null,'',`#${id}`);
  ...
  window.addEventListener('popstate',()=>{
    ...
    restoring=true;
    try{if(typeof window.navigateAdminScreen==='function')window.navigateAdminScreen(id)}finally{restoring=false}
  });
})();
